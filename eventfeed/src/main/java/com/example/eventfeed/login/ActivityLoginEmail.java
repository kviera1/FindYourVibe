...
public class ActivityLoginEmail extends AppCompatActivity {
    ...
    public static void setPeopleGoingEmails(ArrayList<String> peopleGoingEmails) {
        ActivityLoginEmail.peopleGoingEmails = peopleGoingEmails;
    }
    ...
    public static void setEmailStr(String emailStr) {
        ActivityLoginEmail.emailStr = emailStr;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // set up chat and login user, checks for empty fields
    ...
    private void LoginUser(){
        ...
        //log user in with email and pass to firebase   
        mAuth.signInWithEmailAndPassword(email.getText().toString(), Password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            Intent intent= new Intent(ActivityLoginEmail.this, Profile.class);
        ...
        SendBird.connect(userId, new SendBird.ConnectHandler() {
            ...
            public void onConnected(User user, SendBirdException e) {
                ...
                if (e != null) {
                    // Error!
                    Toast.makeText(
                            ActivityLoginEmail.this, "" + e.getCode() + ": " + e.getMessage(),
                            Toast.LENGTH_SHORT)
                            .show();
