...
public final class Profile_guy extends AppCompatActivity {
    @NotNull
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.profile_main2);
        ...
        Button button = (Button) findViewById(id.invite_button_guy);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Profile_guy.this,InviteSent.class));
            }
        });
    }
