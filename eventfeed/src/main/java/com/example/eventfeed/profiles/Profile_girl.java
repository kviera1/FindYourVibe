...
public final class Profile_girl extends AppCompatActivity {
    @NotNull
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.profile_main_girl);
        ...
        Button button = (Button) findViewById(id.invite_button_girl);
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(Profile_girl.this,InviteSent.class));
                    }
                });
    }
