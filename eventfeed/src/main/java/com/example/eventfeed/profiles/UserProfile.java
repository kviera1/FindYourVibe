...
public final class UserProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.user_profile_main);
        ...
        interestsView =(TextView) findViewById(R.id.interests);
    ...
    fetchProfile();
        ...
        drawerLayout = (DrawerLayout) findViewById(R.id.profile_drawable_layout);
        actionBarDrawerToggle = new ActionBarDrawerToggle(UserProfile.this,drawerLayout,R.string.drawer_open, R.string.drawer_close);
        actionBarDrawerToggle = new ActionBarDrawerToggle(UserProfile.this,drawerLayout,R.string.drawer_open, R.string.drawer_close);
...
mDocRef = FirebaseFirestore.getInstance().document("users/"+ ActivityLoginEmail.getEmailStr()+"/profile/profileInfo");
            ...
            public void onClick(View v) {
                ...
                GroupChannel.createChannelWithUserIds(USER_IDS, IS_DISTINCT, new GroupChannel.GroupChannelCreateHandler() {
                    ...
                    public void onResult(GroupChannel groupChannel, SendBirdException e) {
                        ...
                        Bundle b = new Bundle();
                        b.putString("channel",groupChannel.getUrl());
...
cover_photo = (ImageView) findViewById(id.cover_photo);
profile_photo = (ImageView) findViewById(id.profile_picture) ;
mDocRef= FirebaseFirestore.getInstance().document("users/"+ userEmail+"/profile/profileInfo");
    mDocRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
...
profilePics = storageRef.child("images/"+ userEmail+"/profile" );
  profilePics.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
      @Override
      public void onSuccess(Uri uri) {
  ...
  coverPhotos = storageRef.child("images/"+ userEmail+"/cover" );
        ...
        switch(item.getItemId())
        {
            ...
            case id.nav_logout:
                ...
                if(FirebaseAuth.getInstance().getCurrentUser() !=null){
                    ...
                    Intent intent = new Intent(UserProfile.this, RegisterActivity.class);
